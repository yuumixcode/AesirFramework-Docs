---
title: MonoView<T>
description: "Runestone.AesirArchitecture.MonoView<T> 的 API 文档"
---
...
- `T` — 上下文类型，必须继承自 AbstractContext{T} 且具有无参构造函数

## 声明

``` csharp
public abstract class MonoView<T> : UnityEngine.MonoBehaviour, 
