...
```
https://github.com/yuumixcode/AesirFramework.git#AesirModules-v0.21.0
```

只安装 Aesir Modules 时,请同时添加 Aesir Architecture 的 Git URL(UPM 对 Git URL 安装的包不会自动解析包内 dependencies 声明为 Registry 引用):

```
https://github.com/yuumixcode/AesirFramework.git#AesirArchitecture-v0.21.0
```
...
{
  "dependencies": {
    "cn.runestone.aesir.architecture": "https://github.com/yuumixcode/AesirFramework.git#AesirArchitecture-v0.21.0",
    "cn.runestone.aesir.modules": "https://github.com/yuumixcode/AesirFramework.git#AesirModules-v0.21.0"
  }
}
```
