---
title: PropertyData
description: "Runestone.AesirModules.ScriptDocGenerator.PropertyData 的 API 文档"
---
...
**继承链:** `System.Object` → `Runestone.AesirModules.ScriptDocGenerator.MemberData` → `PropertyData`

**实现接口:** `Runestone.AesirModules.ScriptDocGenerator.IPropertyData`，`Runestone.AesirModules.ScriptDocGenerator.IDerivedMemberData`，`Runestone.AesirModules.ScriptDocGenerator.IMemberData`

## 声明

``` csharp
[Serializable]
public class PropertyData : Runestone.AesirModules.ScriptDocGenerator.MemberData, 
Runestone.AesirModules.ScriptDocGenerator.IPropertyData, 
...
| [`ValueSummary`](#property-valuesummary) | 属性值注释（XML <value> 标签）。无注释时为 null |
